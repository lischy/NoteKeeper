...
public class DataManagerTest {
    ...
    public void setUp(){
        ...
        sDataManager.initializeExampleNotes(id);
    }
    ...
    public void createNewNote() {
        ...
        int noteIndex = sDataManager.createNewNote(0);
...
@Test
    public void findSimilarNotes(){
        ...
        int noteIndex1 = sDataManager.createNewNote(0);
        NoteInfo newNote1 = sDataManager.getNotes().get(noteIndex1);
        newNote1.setCourse(course);
        newNote1.setTitle(noteTitle);
        newNote1.setText(noteText1);

        int noteIndex2 = sDataManager.createNewNote(0);
